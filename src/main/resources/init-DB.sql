...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`call_address`;
CREATE TABLE `Hrabovenskyi`.`call_address` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`call`;
CREATE TABLE `Hrabovenskyi`.`call` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`call_has_rescue_vehicle`;
CREATE TABLE `Hrabovenskyi`.`call_has_rescue_vehicle` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`rescuer`;
CREATE TABLE `Hrabovenskyi`.`rescuer` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `surname` VARCHAR(50) NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`hospital`;
CREATE TABLE `Hrabovenskyi`.`hospital` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`injury`;
CREATE TABLE `Hrabovenskyi`.`injury` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`call_has_rescuer`;
CREATE TABLE `Hrabovenskyi`.`call_has_rescuer` (
  `call_id` INT NOT NULL,
